...
class htmlMimeMail
{
    ...
    function htmlMimeMail()
    {
        ...
        $this->build_params['html_charset'] = 'koi8-r';
        $this->build_params['text_charset'] = 'koi8-r';
        $this->build_params['head_charset'] = 'koi8-r';
        ...
        $this->smtp_params['host'] = 'smtp.masterhost.ru';
