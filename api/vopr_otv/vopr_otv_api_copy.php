...
function form_client_vopros($zagl, $clas_zagl, $tbl_border = 0, $tbl_align, $tbl_width, $tbl_cellspacing, $tbl_cellpadding, $clas, $textarea_cols, $textarea_rows, $size, $clas_input)
{
    ...
    echo "<tr class='$clas'><td colspan='2' class='$clas'><textarea class='$clas_input' name='vopros' id='vopros' cols='$textarea_cols' rows='$textarea_rows'>$vopros</textarea></td></tr>";
    echo "<tr class='$clas'><td class='$clas'>Прикрепить файл:</td><td class='$clas'><input class='$clas_input' type='file' name='files' id='files' size='$size'></td></tr>";
    echo "<tr class='$clas'><td colspan='2' align='center'><input class='cls_button_klient' type='submit' name='ask' id='ask' value='Задать вопрос'></td></tr>";
    echo "</form></table>";
}
